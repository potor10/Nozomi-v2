...
router.get('/characters/level/max_cost/:server_id/:unit_id', collection_controller.get_unit_level_max_cost)
...
router.get('/skills/level/max_cost/:server_id/:unit_id/:skill_name', collection_controller.get_skill_max_cost)
...
router.get('/skills/level/level_up', collection_controller.level_up_skill)
