...
// Import Functions
import skillUpCost from './upgrade_components/skill_up_cost.js'
import skillUpMaxCost from './upgrade_components/skill_up_max_cost.js'
...
const skillUp = (discord_id, server_id, unit_id, skill_name, max=false) => {
  ...
  const skill_info = (max) ? skillUpMaxCost(unit, user, skill_name) : skillUpCost(unit, skill_name)

  if (user.mana < skill_info.mana_cost) throw new ApiException(400, 'Not Enough Mana!')
  console.log(skill_info.mana_cost)
